#ifndef __PYTHON_NONLINEAR_MPC_OPTIMIZATION_ENGINE_TESTER_HPP__
#define __PYTHON_NONLINEAR_MPC_OPTIMIZATION_ENGINE_TESTER_HPP__
...
using Tester_MPC_Type = kinematic_bicycle_model_op_en_nonlinear_mpc::type;

class Python_Nonlinear_MPC_Optimization_Engine_Tester {
public:
  /* Constant, Type */
...
#endif // __PYTHON_NONLINEAR_MPC_OPTIMIZATION_ENGINE_TESTER_HPP__
