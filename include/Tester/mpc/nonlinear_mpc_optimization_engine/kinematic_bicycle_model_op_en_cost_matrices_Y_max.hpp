#ifndef __KINEMATIC_BICYCLE_MODEL_OP_EN_COST_MATRICES_Y_MAX_HPP__
#define __KINEMATIC_BICYCLE_MODEL_OP_EN_COST_MATRICES_Y_MAX_HPP__
...
#endif // __KINEMATIC_BICYCLE_MODEL_OP_EN_COST_MATRICES_Y_MAX_HPP__
