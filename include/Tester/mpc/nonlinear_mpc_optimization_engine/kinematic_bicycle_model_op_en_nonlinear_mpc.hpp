...
constexpr std::size_t INPUT_SIZE =
    kinematic_bicycle_model_op_en_nonlinear_mpc_ekf::INPUT_SIZE;
constexpr std::size_t STATE_SIZE =
    kinematic_bicycle_model_op_en_nonlinear_mpc_ekf::STATE_SIZE;
constexpr std::size_t OUTPUT_SIZE =
    kinematic_bicycle_model_op_en_nonlinear_mpc_ekf::OUTPUT_SIZE;

constexpr std::size_t NUMBER_OF_DELAY =
    kinematic_bicycle_model_op_en_nonlinear_mpc_ekf::NUMBER_OF_DELAY;

constexpr bool HAS_OUTPUT_CONSTRAINTS = false;

constexpr std::size_t LBFGS_MEMORY = 5;
...
using EKF_Type = kinematic_bicycle_model_op_en_nonlinear_mpc_ekf::type;

using Parameter_Type =
    kinematic_bicycle_model_op_en_nonlinear_mpc_ekf_parameter::Parameter_Type;

using Cost_Matrices_Type = kinematic_bicycle_model_op_en_cost_matrices::type;
...
using type =
    NonlinearMPC_OptimizationEngine_Type<EKF_Type, Cost_Matrices_Type,
                                         HAS_OUTPUT_CONSTRAINTS, LBFGS_MEMORY>;

inline auto make(void) -> type {

  auto kalman_filter = kinematic_bicycle_model_op_en_nonlinear_mpc_ekf::make();

  auto cost_matrices = kinematic_bicycle_model_op_en_cost_matrices::make();
  ...
  auto nonlinear_mpc = make_NonlinearMPC_OptimizationEngine<
