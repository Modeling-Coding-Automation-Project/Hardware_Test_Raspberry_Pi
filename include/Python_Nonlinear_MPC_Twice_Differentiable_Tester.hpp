#ifndef PYTHON_NONLINEAR_MPC_TWICE_DIFFERENTIABLE_TESTER_HPP_
#define PYTHON_NONLINEAR_MPC_TWICE_DIFFERENTIABLE_TESTER_HPP_
...
namespace state_equation =
    kinematic_bicycle_model_nonlinear_mpc_ekf_state_equation;
namespace measurement_equation =
    kinematic_bicycle_model_nonlinear_mpc_ekf_measurement_equation;
...
#endif // PYTHON_NONLINEAR_MPC_TWICE_DIFFERENTIABLE_TESTER_HPP_
